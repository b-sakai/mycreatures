package com.websarva.wings.android.opengl
...
const val FRAGMENT_SHADER_UNIFORM_TIME = "uTime"
...
class QuadRender(
    ...
    private var uTime = UNKNOWN_ATTRIBUTE
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        uTime = GLES30.glGetUniformLocation(program, FRAGMENT_SHADER_UNIFORM_TIME)
        checkGlError("glGetUniformLocation $FRAGMENT_SHADER_UNIFORM_TIME")
        if (uTime == UNKNOWN_ATTRIBUTE) throw RuntimeException("Could not get uniform location for $FRAGMENT_SHADER_UNIFORM_TIME")
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        val uTimeValue = systemTime % (1000 * 8)
        GLES30.glUniform1f(uTime, uTimeValue / 8000f)
